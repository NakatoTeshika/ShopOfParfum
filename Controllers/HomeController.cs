...
{   
    ...
    public class HomeController : Controller
    {
      ...
      ///  [Authorize]
        ...
        [HttpGet]
        public ViewResult MyAction(string brand)
        {
            List<Good> br;
            if(brand !=null)
            {
                br = repository.Goods.Where(y=>y.Brand == brand).ToList();
            }
            else 
            {
                br = repository.Goods.ToList();
            }
            return View(br);
        }
        ...
        public IActionResult Main(string street)
        {
            List<Good> w;
            if(street != null)
            {
        ...
        // public IActionResult Main(string brand)
        // {
        //     List<Good> br;
        //     if(brand != null)
        //     {
